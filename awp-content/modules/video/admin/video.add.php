...
$msg	  = '';
$youtubeId = @$_POST['add_youtube_id'];
$youtubeTitle 	= @$_POST['add_youtube_title'];
$youtubeDes 	= @$_POST['add_youtube_description'];
...
if(isset($_POST['add_youtube_id'])){
	...
	elseif(empty($_POST['add_youtube_title'])){
		...
		$sql 		= "insert into ".$this->table_prefix."video set youtube_id='".$youtubeID."',section_id='".$_POST['add_section_id']."',video_title='".$youtubeTitle."',video_description='".$youtubeDes."',thumbnail='".$newThumb."',publish='1',created_date='".date('Y-m-d h:i:s')."'";
		...
		if($this->db->execute($sql)){
			...
			$msg = $this->form->alert('success','New video added.');
			$youtubeId = '';
			$youtubeTitle = '';
			$youtubeDes = '';
		}
			...
			<div class="row">
				<div class="col-md-5">
					<div class="video-frame">
						<span aria-hidden="true" class="glyphicon glyphicon-play icon-vid"></span>
						<div class="vide-progress"></div>
					</div>
				</div>
				<div class="col-md-7">
					<div class="row">
