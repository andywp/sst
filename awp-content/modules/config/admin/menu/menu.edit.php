...
if(!$this->site->isMultiLang()){
	...
	$params = array(
		...
		$this->form->input->icon('Select icon', 'add_icon','-page'),
	...
	$categoryParams = array(
		...
		$this->form->input->icon('Select icon', 'add_icon','-category'),
		$this->form->input->hidden('add_publish',1)
	);
	...
	$customParams = array(
		...
		$this->form->input->select('Target', 'add_target', $targetURL,$multiple=false,'class="select2 select-cat form-control"'),
		$this->form->input->icon('Select icon', 'add_icon','-custom'),
		$this->form->input->hidden('add_publish',1),
