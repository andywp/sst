...
$parent = array(
	...
	'reftable'	=> array(
		...
		'id' 	=> 'category_id',
		'field'	=> 'category_name',
		'cond' 	=> 'where category_type=\'main\' and category_id<>\''.$catID.'\''
	)
);
...
<?$this->form->getForm('edit',$sqltable,$params,$formName='category',$submitValue='Update Section',$redirect,$resetBotton=false);?>
