...
$params	= array(
	...
	$this->form->input->image('Default Image <small class="text-warning">(Best size 1600px x 500px)</small>','add_category_image',uploadPath.'modules/category/',uploadPath.'modules/category/thumbs/','image', $setWidth=1600),
	...
	$this->form->input->hidden('add_category_type', 'main'),
...
function addToPage($db,$post,$table_prefix,$isMultiLang,$lang,$user){
	...
	$mainPage = "insert into ".$table_prefix."pages set module_id='".$postID."', ".$setField." category_id='".$categoryID."', page_switch='post_section',  publish='1'";
	$db->execute($mainPage);
...
<?$this->form->getForm('add',$sqltable,$params,$formName='category',$submitValue='Add Section',true); ?>
