...
if(count($arrPosition)>0){
	...
	foreach($arrPosition as $positionID=>$positionVal){
		...
		$showWidgetBody		 = $nWidget==1?'':' style="display: none;"';
		@$widgetPosition 	.= '<div class="widget-box'.$showWidgetBox.'">';
		$widgetPosition 	.= '<div class="widget-header"><h4 class="widget-title">'.$positionID.'</h4><div class="widget-toolbar"><a data-action="collapse" href="#"><i class="ace-icon fa '.$chrvIcon.'"></i></a></div></div>';
		$widgetPosition 	.= '<div class="widget-body"'.$showWidgetBody.'>';
	...
	echo $this->form->alert('warning','No widget registered');
}
?>