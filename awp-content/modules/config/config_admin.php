...
switch($this->getSwitch()){	
	...
	/* category */
    case 'category':
		include modulePath.$this->thisModule().'/admin/maincategory/category.php';	
	break;
    case 'add_category':
		include modulePath.$this->thisModule().'/admin/maincategory/category.add.php';	
	break;
    case 'edit_category':
		include modulePath.$this->thisModule().'/admin/maincategory/category.edit.php';	
	break;
