...
--
-- Table structure for table `cni_banner`
--
...
--
-- Dumping data for table `cni_banner`
--

INSERT INTO `cni_banner` (`banner_id`, `banner_title`, `banner_link`, `banner_image`, `banner_order`, `banner_position`, `publish`) VALUES
