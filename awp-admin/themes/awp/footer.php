...
<script type="text/javascript">
	jQuery(function($) {
		...
		function getMessage(){
			...
			var xajaxFile = ajaxURL+"awp-content/modules/home/widget/bar.contactus.getmessage.php";
		...
		$(document).on('click','.btn-contact-detail',function(){
			...
			var xajaxFile = ajaxURL+"awp-content/modules/home/widget/bar.contactus.update.php";
