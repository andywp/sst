          ...
          <!-- Messages: style can be found in dropdown.less-->
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo $this->adminURL()?>my-account<?php echo $this->permalink()?>" class="btn btn-primary btn-flat">My account</a>
                </div>
                <div class="pull-right">
									<?php if($this->admin('group_id')==1){ ?>
									<a href="<?php echo $this->reloginURL()?>" class="btn btn-info btn-flat">Relogin</a>
									<?php } ?>
                  <a href="<?php echo $this->logoutURL()?>" class="btn btn-danger btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
